# Test speed of tile creation from raster image formats
#
...
raster_files = ["D:/GeoData/Sentinel/format/S2A_OPER_MSI_L2A_20160107.tif",
                "D:/GeoData/Sentinel/format/S2A_OPER_MSI_L2A_20160107_f.img",
                "D:/GeoData/Sentinel/format/S2A_OPER_MSI_L2A_20160107_e.img",
                "D:/GeoData/Sentinel/format/S2A_OPER_MSI_L2A_20160107_i.tif"]
raster_tiles = "D:/GeoData/Sentinel/format/tiles/"
...
for raster_file in raster_files:
    ...
    for i, x in enumerate(tiles_x):
        for j, y in enumerate(tiles_y):
            ...
            translate = "gdal_translate -srcwin %s %s %s %s %s %s" %(x_min, y_min, x_tile, y_tile, raster_file, tile_file)
            os.system(translate)
