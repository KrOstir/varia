...
# %%
calendar = calendar[['Datum roka', 'Ura', 'Predmet',
                     'Predavalnica', 'Opombe']].dropna(subset=['Predmet'])
...
# %%
calendar['AllDay'] = calendar['Ura'].apply(
    lambda x: x in ['00:00:00', '00:01:00'])
...
# %%
calendar.columns = ['Start Date', 'Start Time', 'Location', 'Description', 'Subject', 'All day event']
